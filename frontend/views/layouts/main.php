...
list($clientA, $todoA) = [false, false];
            ...
            <nav>
                ...
                <?= Menu::widget([
                    ...
                    'items' => [
                        ...
                        ['label' => 'Дела'.(($clientA || $todoA)?'<span class="work_value"> (<span>'.(\Yii::$app->todo->cur() + \Yii::$app->todo->last()).'</span>)</span>':''), 'url' => ['todo/index'], 'active' => $checkController('todo')],
                    ],
